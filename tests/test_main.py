...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            FrontendDeveloper,
            ["__init__", "learn_skill", "create_awesome_web_page"],
        ),
        (BackendDeveloper, ["__init__", "learn_skill", "create_powerful_api"]),
        (
            AndroidDeveloper,
            ["__init__", "learn_skill", "create_smooth_mobile_app"],
        ),
        (
            FullStackDeveloper,
            [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            FrontendDeveloper(""),
            ["TypeScript", "React"],
            ["JavaScript", "CSS", "HTML", "TypeScript", "React"],
        ),
        (
            BackendDeveloper(""),
            ["Golang"],
            ["Python", "SQL", "Django", "Golang"],
        ),
        (
            FullStackDeveloper(""),
            ["AWS", "React"],
...
@pytest.mark.parametrize(
    "function,result",
    [
        (SoftwareEngineer.__init__, {"name": str, "return": type(None)}),
        (SoftwareEngineer.learn_skill, {"skill": str, "return": type(None)}),
        (FrontendDeveloper.__init__, {"name": str, "return": type(None)}),
        (FrontendDeveloper.create_awesome_web_page, {"return": str}),
        (BackendDeveloper.__init__, {"name": str, "return": type(None)}),
        (BackendDeveloper.create_powerful_api, {"return": str}),
        (AndroidDeveloper.__init__, {"name": str, "return": type(None)}),
        (AndroidDeveloper.create_smooth_mobile_app, {"return": str}),
        (FullStackDeveloper.__init__, {"name": str, "return": type(None)}),
        (FullStackDeveloper.create_web_application, {"return": type(None)}),
    ],
)
